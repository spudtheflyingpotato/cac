...
(function(a){AJS.toInit(function(){var b=AJS.Meta.get("build-number");if(b>=4527&&b<4726){a("body").addClass("sv-conf53")}else{if(b>=4726&&b<5501){a("body").addClass("sv-conf54")}else{if(b>=5780&&b<5980){a("body").addClass("sv-conf57")}else{if(b>=5980){a("body").addClass("sv-conf58")}}}}})})(AJS.$);
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
Confluence.Templates.User.logo = function(opt_data, opt_ignored) {
  return '' + ((opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) ? '<a ' + ((opt_data.canView) ? ' ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '') + ' href="' + soy.$$escapeHtml("") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml("Add a picture of yourself") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/s/en_GB/6220/de9b463eb65c5ca13c0266eed77e2bf49f4c6fe8.27/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Add a picture of yourself") + '"></a>' : (opt_data.profilePictureInfo.anonymous) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/en_GB/6220/de9b463eb65c5ca13c0266eed77e2bf49f4c6fe8.27/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Anonymous") + '" title="' + soy.$$escapeHtml("Anonymous") + '">' : (opt_data.canView) ? '<a ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '" href="' + Confluence.Templates.User.userLinkUrl(opt_data) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml("") + soy.$$escapeHtml(opt_data.profilePictureInfo.downloadPath) + '" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '"></a>' : '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/en_GB/6220/de9b463eb65c5ca13c0266eed77e2bf49f4c6fe8.27/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '">');
};
if (goog.DEBUG) {
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_ignored) {
  return '<p class="comment-user-logo">' + ((opt_data.userInfo.userName == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/en_GB/6220/de9b463eb65c5ca13c0266eed77e2bf49f4c6fe8.27/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Anonymous") + '" title="' + soy.$$escapeHtml("Anonymous") + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml("") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml("Add a picture of yourself") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/s/en_GB/6220/de9b463eb65c5ca13c0266eed77e2bf49f4c6fe8.27/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml("Add a picture of yourself") + '"></a>' : '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + Confluence.Templates.User.userLinkUrl({username: opt_data.userInfo.userName}) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml("User icon") + ': ' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '"></a>') + '</p>';
};
if (goog.DEBUG) {
...
Scroll.Viewport.Page.Templates.openerDialog = function(opt_data, opt_ignored) {
  return '<h2>Scroll Viewport</h2><p>This space is available through a viewport.</p><p class="sp-buttons"><a href="' + soy.$$escapeHtml(opt_data.pageViewportUrl) + '" class="aui-button aui-button-primary"><span class="aui-icon aui-icon-small aui-iconfont-view">Open </span> Open</a>' + ((opt_data.canManageViewport) ? '<a href="' + soy.$$escapeHtml(opt_data.manageViewportUrl) + '" class="aui-button"><span class="aui-icon aui-icon-small aui-iconfont-configure">Configure </span> Configure</a>' : '') + '</p>';
};
if (goog.DEBUG) {
...
(function ($) {
    ...
    AJS.toInit(function () {
        ...
        $.getJSON(contextPath + '/rest/scroll-viewport/1.0/viewport-control?pageId=' + AJS.params.pageId)
        ...
        function insertViewportIcon() {
            ...
            $byLineEl.before('<li class="sp-control-opener"><a href="#"></a></li>');
        }


        function setupOpenerDialog(viewportControl) {
            AJS.InlineDialog($('.sp-control-opener'), 'sp-control-opener-dialog',
                function (content, trigger, showPopup) {
                    content
                        .css({'padding': '20px'})
                        .html(Scroll.Viewport.Page.Templates.openerDialog(viewportControl));
        ...
        function showViewportTeaser(viewportControl) {
            $('body')
                .prepend('<div class="sp-viewport-teaser-trigger"/>')
            ...
            var teaserDialog = AJS.InlineDialog($('.sp-viewport-teaser-trigger'), 'sp-viewport-teaser',
                function (content, trigger, showPopup) {
                    content
                        .css({'padding': '20px'})
                        .html(Scroll.Viewport.Page.Templates.teaserDialog(viewportControl));
            ...
            teaserDialog.show();
            $('.sp-teaser-dialog-close').live('click', teaserDialog.hide);
            $('#sp-gotit').live('change', function() {
                if ($(this).is(":checked")) {
...
(function(a){AJS.bind("init.rte",function(){AJS.MacroBrowser.setMacroJsOverride("conditionalcontent",{opener:function(b){Scroll.Versions.loadPageContextApp().then(function(c){c.DialogManager.openAttributesDialog({currentMacro:b})})}})})})(AJS.$);
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
Scroll.Versions.IncludePlus.Templates.popupContent = function(opt_data, opt_ignored) {
  return '<div class="sv-infopopup sv-includeinfo"><h3>' + soy.$$escapeHtml("Included Content") + '</h3><h5>' + soy.$$escapeHtml("Included Page:") + '</h5><p><a href="' + soy.$$escapeHtml(contextPath) + soy.$$escapeHtml(opt_data.includedScrollPage.confluencePage.urlPath) + '" target="_blank">' + soy.$$escapeHtml(opt_data.includedScrollPage.scrollPageTitle) + ' <span class="icon icon-newwindow" title="' + soy.$$escapeHtml("Open in new Window") + '"></span></a> (<nobr>' + soy.$$escapeHtml(opt_data.includedScrollPage.targetVersion.name) + '</nobr>)</p></div>';
};
if (goog.DEBUG) {
...
(function(a){Confluence.Plugins=Confluence.Plugins||{};Confluence.Plugins.Publisher={};Confluence.Plugins.Publisher.DraftManager=function(){};Confluence.Plugins.Publisher.DraftManager.prototype.create=function(c,b){return a.ajax({type:"POST",contentType:"application/json",url:AJS.Confluence.getContextPath()+"/rest/publisher/latest/draft/create",data:a.toJSON({originalId:c,title:b})})};Confluence.Plugins.Publisher.DraftManager.prototype.publish=function(b,c){return a.ajax({type:"POST",contentType:"application/json",url:AJS.Confluence.getContextPath()+"/rest/publisher/latest/draft/publish",data:a.toJSON({id:b,comment:c})})};Confluence.Plugins.Publisher.DraftManager.prototype.get=function(b){return a.ajax({type:"GET",url:AJS.Confluence.getContextPath()+"/rest/publisher/latest/draft/drafts",data:{draftPageIds:b}})};Confluence.Plugins.Publisher.CreateDraftDialog=function(b){var c=this;this.dialog=new AJS.Dialog(400,180);this.draftManager=b;this.dialog.addHeader("Create Draft").addPanel("Panel 1","panel1").addSubmit("Create",function(){createDraft(c);return false}).addCancel("Cancel",function(){c.dialog.hide()});this.dialog.getCurrentPanel().html(AJS.renderTemplate("create-draft"));a("form.create-draft-dialog").submit(function(){createDraft(c);return false})};Confluence.Plugins.Publisher.CreateDraftDialog.prototype.open=function(){this.dialog.show();a("form.create-draft-dialog input")[0].value="DRAFT - "+AJS.params.pageTitle};createDraft=function(c){var b=c.draftManager;var e=c.dialog;var d=a("form.create-draft-dialog input")[0].value;var f=AJS.params.pageId;b.create(f,d).success(function(g){e.remove();window.location=AJS.params.contextPath+g}).error(function(g){alert(g.responseText)})};Confluence.Plugins.Publisher.PublishingDialog=function(c,b){var d=this;this.draftManager=b;this.pagesToPublish=c;this.dialog=new AJS.Dialog(600,480,"publisher-dialog");this.dialog.addHeader("Publish").addPanel("Panel 1","panel1").addSubmit("Publish",function(){publish(d)}).addCancel("Cancel",function(){d.dialog.remove()}).addPage("publisher-progress").addHeader("Publish").addPanel("Panel 2","panel2").addSubmit("Done",function(){d.dialog.remove();window.location.reload()});this.dialog.getPanel(0,0).html(AJS.renderTemplate("publisher-dialog-page1"));this.dialog.getPanel(1,0).html(AJS.renderTemplate("publisher-dialog-page2"));this.dialog.gotoPage(0);a("form.publish-comment-form").submit(function(){publish(d);return false});AJS.bind("show.dialog",function(g,f){if(f.dialog.id=="publisher-dialog"){b.get(c).done(function(e){for(i in e){a(".publisher-dialog-pages table").append(AJS.renderTemplate("publisher-dialog-page",e[i].title,AJS.Confluence.getContextPath()+e[i].url))}}).fail(function(){alert(f.responseText)});AJS.unbind("show.dialog",g.handler)}})};Confluence.Plugins.Publisher.PublishingDialog.prototype.open=function(){this.dialog.show()};publishNextPage=function(e,b,f,c){var d=e.pagesToPublish;a(".publisher-dialog-progress-message").text("Publishing "+(b+1)+" of "+d.length);e.draftManager.publish(d[b],f).done(function(l){var k="";var j="";var h="";if(l.draft.currentOriginalVersion>l.draft.originalVersionAtDraftCreation){j=AJS.params.contextPath+AJS.format("/pages/diffpagesbyversion.action?pageId={0}&selectedPageVersions={1}&selectedPageVersions={2}",l.draft.originalId,l.draft.currentOriginalVersion,l.draft.originalVersionAtDraftCreation);h="view changes"}else{k="No changes"}a(".publisher-dialog-pages-progress table").append(AJS.renderTemplate("publisher-dialog-page-progress",l.title,AJS.params.contextPath+l.url,k,j,h));var g=b+1;if(d.length>g){publishNextPage(e,g,f,c)}else{a(".publisher-dialog-progress-message").text("Successfully published "+d.length+" pages.");a(".publisher-dialog-progress-icon").addClass("done");c();a("#publisher-dialog .button-panel-submit-button").enable();a("#publisher-dialog .button-panel-submit-button").focus()}}).fail(function(g){alert(g.responseText)})};publish=function(d){var c=d.dialog;var e=a("#publish-comment").val();a("#publish-comment").blur();c.nextPage();a("#publisher-dialog .button-panel-submit-button").disable();var b=Raphael.spinner(a(".publisher-dialog-progress-icon")[0],7,"#666");publishNextPage(d,0,e,b)};AJS.toInit(function(c){var b=new Confluence.Plugins.Publisher.DraftManager();AJS.I18n.get("com.atlassian.confluence.plugins.confluence-publisher-plugin");c("#createdraftlink").click(function(d){new Confluence.Plugins.Publisher.CreateDraftDialog(b).open();return d.preventDefault()});c("#publish-button").click(function(g){var f=new Array();c(".draft-publishing input[name=pageId]").each(function(){if(this.checked){f.push(this.value)}});var d=new Confluence.Plugins.Publisher.PublishingDialog(f,b).open();return g.preventDefault()});c(".draft-publishing input[name=pageId]").change(function(){if(c(".draft-publishing input[name=pageId]:checked").length==0){c("#publish-button").disable()}else{c("#publish-button").enable()}});c(".draft-publishing .select-all").click(function(){if(c(".draft-publishing .select-all:checked").length==0){c(".draft-publishing input[name=pageId]").prop("checked",false)}else{c(".draft-publishing input[name=pageId]").prop("checked",true)}})})})(AJS.$);
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
